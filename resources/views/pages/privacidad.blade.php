...
@section('title', 'Políticas de Privacidad | BET CAPITAL SAC')
...
@section('content')
    ...
    <section class="relative h-[280px] flex items-center overflow-hidden bg-primary hero-diagonal">
        ...
        <div class="relative z-20 w-full max-w-[1440px] mx-auto px-margin text-white -mt-6">
            <h1 class="font-headline-xl text-headline-xl text-white">Política de Privacidad</h1>
            <p class="font-body-lg text-body-lg text-primary-fixed opacity-95">Protección de datos personales y confidencialidad en BET CAPITAL SAC.</p>
        </div>
    </section>
        ...
        <div class="max-w-[1440px] mx-auto px-margin">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <aside class="lg:col-span-4 bg-surface-container-lowest border border-outline-variant p-6 rounded-sm sticky top-24">
                    <h3 class="font-label-bold text-label-bold text-ocean-deep uppercase tracking-widest border-b border-outline-variant pb-3 mb-4">Índice de Políticas</h3>
                    <nav class="space-y-2">
                        ...
                        @empty
                            <p class="text-xs text-on-surface-variant/70 italic">No hay políticas registradas.</p>
                        @endforelse
                    </nav>
                </aside>
                ...
                <main class="lg:col-span-8 bg-surface-container-lowest border border-outline-variant p-8 rounded-sm space-y-8">
                    ...
                    @empty
                        <div class="text-center py-12">
                            <span class="material-symbols-outlined text-4xl text-on-surface-variant/40 mb-2">security</span>
                            <p class="text-on-surface-variant">Políticas de protección de datos en proceso de actualización.</p>
                        </div>
                    @endempty
                </main>
